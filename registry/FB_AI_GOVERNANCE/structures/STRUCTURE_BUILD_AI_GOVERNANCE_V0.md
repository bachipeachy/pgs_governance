# STRUCTURE_BUILD_AI_GOVERNANCE_V0
...
Build configuration for AI governance domain layer. Defines artifact discovery scope, layer visibility, and output paths for independent AI governance domain build.

**Scope**: AI governance domain build (sovereign)
...
```yaml
structure_code: STRUCTURE_BUILD_AI_GOVERNANCE_V0
version: V0
...
core:
  ...
  description: Independent build configuration for AI governance domain layer

  build_mode: domain
  current_domain: AI_GOVERNANCE
